/*
  Nombre completo: ingreso.controller.js
  Ruta o ubicación: src/modules/registro/ingreso/ingreso.controller.js

  Función o funciones:
    - Montar la pantalla de Registro / Ingreso.
    - Validar y guardar peso diario.
    - Validar y guardar medidas semanales.
    - Pedir confirmación cuando hay cambios poco comunes.

  Se conecta con:
    - src/modules/registro/ingreso/ingreso.view.js
