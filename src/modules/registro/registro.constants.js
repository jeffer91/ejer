/*
  ...
  Ruta o ubicación: src/modules/registro/registro.constants.js

  Función o funciones:
    - Centralizar nombres, claves y reglas generales del módulo Registro.
    - Definir datos de perfil, peso diario y medidas semanales.
    - Evitar textos y claves repetidas dentro del módulo.

  Se conecta con:
    - src/modules/registro/registro.module.js
